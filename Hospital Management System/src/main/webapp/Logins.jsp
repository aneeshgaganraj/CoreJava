    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
      <div class="container-fluid">
        <a class="navbar-brand" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23"
          ...
          </svg>Online Hospital Management System</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form class="d-flex" role="search" action="DispData" method="get">
            <input class="form-control me-2" type="search" placeholder="Enter your id" aria-label="Search" name="id">
  ...
  <div class="sports-card">
    ...
    <div class="cardss">
      <div class="card" style="width: 18rem;">
        <img src="appoi.png" class="card-img-top" alt="register.jsp">
        <div class="card-body">
      ...
      <div class="card" style="width: 18rem;">
        <img src="doctor_1196-269.avif" class="card-img-top" alt="register.jsp">
        <div class="card-body">
      ...
      <div class="card" style="width: 18rem;">
        <img src="download.png" class="card-img-top" alt="register.jsp">
        <div class="card-body">
          <h5 class="card-title">Patient</h5>
          <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's
            content.</p>
          <a href="register.jsp" class="btn btn-primary">Details</a>
        </div>
      </div>
      <div class="card" style="width: 18rem;">
        <img src="images (1).png" class="card-img-top" alt="register.jsp">
        <div class="card-body">
